...
| Coach | OpenRouter / `google/gemma-4-31b-it:free` | Free multilingual model whose catalog advertises tool support | Free-route capacity is provider-dependent; no paid fallback is automatic |
